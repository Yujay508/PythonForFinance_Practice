...
class MACD_Sta(bt.Strategy):
    ...
    def notify_trade(self, trade):
        ...
        self.log('OPERATION PEOFIT, GROSS %.2f, NET %.2f' %
    ...
    def next(self):
        ...
        # 反之有庫存則判斷是否有賣出機會
            ...
            # 條件一，當前(n)小於昨日(n-1)高，但n-1高大於n-2高，且n-2大於n-3
...
if __name__ == '__main__':
    ...
    for stock in stock_list:
        ...
        yf_data = yf_data.history(start='2019-01-01', end='2022-04-11')
        ...
        # 儲存相片
        figure[0][0].savefig(f'/mnt/d/7.finance_python/result_{stock}.png')
        # 關閉相片
        plt.close()
    ...
    final_pd.to_excel('/mnt/d/7.finance_python/a.TRADING/result.xlsx')
